...
import com.example.movie_review_chapter07.databinding.ItemFeaturedMovieBinding
import com.example.movie_review_chapter07.databinding.ItemMovieBinding
...
class HomeAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    fun addData(featuredMovie: FeaturedMovie?, movies: List<Movie>) {
        ...
        featuredMovie?.let {
            newData += DataItem("🔥 요즘 핫한 영화")   // String이므로 Header
            newData += DataItem(it)
        }
