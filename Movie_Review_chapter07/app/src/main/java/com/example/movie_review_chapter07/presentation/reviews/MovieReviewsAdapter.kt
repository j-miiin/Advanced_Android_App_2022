...
import com.example.movie_review_chapter07.databinding.ItemMyReviewBinding
import com.example.movie_review_chapter07.databinding.ItemReviewBinding
import com.example.movie_review_chapter07.databinding.ItemReviewFormBinding
...
class MovieReviewsAdapter(private val movie: Movie) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    // my review가 없으면 입력 가능한 form을, 있으면 내 리뷰를 넣어줄 것이므로
    // 헤더와 리뷰 form/my review가 review 이전에 항상 있음
    ...
    companion object {
        ...
        private const val ITEM_VIEW_TYPE_REVIEW_FORM = 2
        private const val ITEM_VIEW_TYPE_MY_REVIEW = 3
    }
}